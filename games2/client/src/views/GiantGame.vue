...
import GameTrack from '../components/GianGame/GameTrack.vue'
import BetPanel from '../components/BetPanel.vue'
import GiantResultModal from '../components/GianGame/GiantResultModal.vue'
import RecordModal from '../components/RecordModal.vue'
import GiantTrendModal from '../components/GianGame/GiantTrendModal.vue'

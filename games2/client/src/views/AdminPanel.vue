<template>
  <div class="admin-panel">
    ...
    <div class="block-grid">
      ...
      <!-- ★ 新增：激活码管理入口 -->
      <div class="block block-vip" @click="activeModal = 'activation'">
        <span class="block-icon">🎫</span>
        <span class="block-label">激活码管理</span>
      </div>
    ...
    <!-- ★ 新增：激活码管理弹窗 -->
    <ActivationCodeManager v-if="activeModal === 'activation'" @close="activeModal = ''" />
  </div>
</template>
...
import MatchStatsManager from '../components/admin/MatchStatsManager.vue'
...
import ActivationCodeManager from '../components/admin/ActivationCodeManager.vue' // ★ 引入新组件
...
.block-match { border-color: rgba(255, 107, 157, 0.4); }
.block-vip { border-color: rgba(138, 43, 226, 0.5); } /* ★ 新增样式 */

  ...
  <div class="bet-panel" ref="panelRef" :style="{ '--chip-size': chipSize + 'px' }">
    ...
    <div class="choice-section">
      ...
      <div class="choice-buttons">
          ...
          <div class="chip-stack">
            <transition-group name="chip-land" tag="div" class="stack-container">
              ...
              >
                ...
                <span class="stacked-amount">{{ bet.amount }}</span>
              </div>
            </transition-group>
          </div>
          <div class="bet-total" v-if="totals.red > 0">{{ totals.red }}</div>
        </div>
        ...
        <div class="choice-btn draw-btn" :class="{ active: choice === 'draw' }" @click="placeBet('draw')">
          ...
          <div class="bet-total" v-if="totals.draw > 0">{{ totals.draw }}</div>
        </div>
        ...
        <div class="choice-btn blue-btn" :class="{ active: choice === 'blue' }" @click="placeBet('blue')">
          ...
          <div class="bet-total" v-if="totals.blue > 0">{{ totals.blue }}</div>
        </div>
      </div>
    </div>
    ...
    <div class="action-section">
      <div class="bet-info" v-if="totalBet > 0">
        总下注: <span class="total-amount">{{ totalBet }}</span>
        <span class="balance-info"> | 余额: {{ balance }}</span>
      </div>

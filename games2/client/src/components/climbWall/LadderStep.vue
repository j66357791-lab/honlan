  ...
  <div class="ladder-step" :class="stepClass">
    <div class="step-left">
      ...
      <div class="step-badge">
        <span v-if="status === 'available'">🌟</span>
    ...
    <div class="step-center">
      ...
      <div class="step-detail">
        ...
        ➜ 获得 <span class="num-font highlight purple">{{ (config.rewardCrystal / 1000).toFixed(2) }}</span> 晶石
      </div>
    </div>
    ...
    <div class="step-right">
      ...
      <!-- 已完成状态：显示今日已爬 -->
      <div v-else-if="status === 'completed'" class="status-text completed-text">✅ 今日已爬</div>
      <!-- 未解锁状态 -->
...
/* 已完成状态：微微变绿背景 */
.is-completed {
  background: rgba(27, 176, 105, 0.08);
  border-color: rgba(27, 176, 105, 0.2);
}
...
.is-completed .step-badge { background: #1bb069; color: #fff; box-shadow: 0 0 8px rgba(27,176,105,0.2); }

.step-center { flex: 1; }
.step-title { font-size: 15px; font-weight: 700; color: #333; margin-bottom: 4px; }
.is-completed .step-title { color: #1bb069; } /* 标题变绿 */

...
export const RULES = [
  ...
  // =====================================================
  {
    ...
    action: (ctx) => {
      ...
      return {
        ...
        constraints: {},
        reason: `R101_ALGO(P:${profit}, Pool:${(poolRate*100).toFixed(0)}%, F:${factor.toFixed(2)})`
      };
    }
  },
  {
  ...
  // =====================================================
  {
    ...
    action: (ctx) => {
      ...
      return { action: 'ADJUST', modifier: { _all: factor, ...specialModifier }, constraints: {}, reason: `SMALL_STAKE_COMFORT(Losses:${losses}, F:${factor.toFixed(2)})`
 };
    }
  },
];

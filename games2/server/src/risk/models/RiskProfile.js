...
riskProfileSchema.methods.settle = function({ betAmount, payout, won, gameId }) {
  ...
  if (won) { this.consecutiveWins += 1; this.consecutiveLosses = 0; } 
  else { this.consecutiveLosses += 1; this.consecutiveWins = 0; }
  ...
  if (gameId === 'giant_racing') { this.lastRacingBetAmount = betAmount; }
  return this;
};
